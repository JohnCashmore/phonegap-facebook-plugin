                ...
                if (canPresentShareDialog) {
                    Runnable runnable = new Runnable() {
                        public void run() {
                            ...
                            OpenGraphObject treat = OpenGraphObject.Factory.createForPost(paramBundle.getString("action_type"));
                            ...
                            try {
                                ...
                                while (iter.hasNext()) {
                                    ...
                                    treat.setProperty(key.toString(), ogActionProperties.getString(key).toString());
                                }
                            } catch (JSONException e) {
                                e.printStackTrace();
                            }
                            ...
                            action.setProperty(paramBundle.getString("action_property_name"), treat);
                            if(paramBundle.containsKey("tags")) {
                                action.setProperty("tags", paramBundle.getString("tags"));
                            }

                            FacebookDialog shareDialog = new FacebookDialog.OpenGraphActionDialogBuilder(me.cordova.getActivity(), action, paramBundle.getString("action_type"), paramBundle.getString("action_property_name"))
                                .build();
